...
contract EthenaMintingACLTest is EthenaMintingUtils {
  ...
  function test_redeem_notRedeemer_revert() public {
    (IEthenaMinting.Order memory redeemOrder, IEthenaMinting.Signature memory takerSignature2) =
      redeem_setup(_usdeToMint, _stETHToDeposit, stETHToken, 1, false);
  ...
  function test_collateralManager_canTransfer_custody() public {
    ...
    EthenaMintingContract.grantRole(collateralManagerRole, minter);
    vm.stopPrank();
    vm.prank(minter);
  ...
  function test_gatekeeper_can_remove_collateral_manager() public {
    ...
    EthenaMintingContract.removeCollateralManagerRole(collateralManager);
    assertFalse(EthenaMintingContract.hasRole(collateralManagerRole, collateralManager));
  }
  ...
  function test_fuzz_not_gatekeeper_cannot_remove_collateral_manager_revert(address notGatekeeper) public {
    ...
    EthenaMintingContract.removeCollateralManagerRole(collateralManager);
    assertTrue(EthenaMintingContract.hasRole(collateralManagerRole, collateralManager));
  }
  ...
  function test_gatekeeper_cannot_add_collateral_managers_revert() public {
    ...
    EthenaMintingContract.grantRole(collateralManagerRole, bob);
    assertFalse(EthenaMintingContract.hasRole(collateralManagerRole, bob), "Bob should lack the collateralManager role");
  }
  ...
  function testCorrectInitConfig() public {
    EthenaMinting ethenaMinting2 = new EthenaMinting(
      IUSDe(address(usdeToken)), weth, assets, custodians, randomer, _maxMintPerBlock, _maxRedeemPerBlock
    );
